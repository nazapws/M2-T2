...
let principal = document.getElementById("nuevoup")

let tarjetas =  " "


for (even of eventosFuturos){
...
const check = document.getElementById("cateup")
const barratexto = document.getElementById("barraup")

barratexto.addEventListener("input", ()=>{
    let primerFiltro = filtrarBarra(eventosFuturos,barratexto.value)
